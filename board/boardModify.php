...
<?php
    ...
    if($result){
        ...
        echo "<div><label for='youPass'>비밀번호</label><input type='youPass' name='youPass' id='youPass' placeholder='로그인 비밀번호를 입력해주세요!'autocomplete='off' required></input></div>";
    }
?>
                            <!-- <div>
                            ...
                            <div>
                                ...
                                <input type="password" name="boardPass" id="boardPass" placeholder="로그인 비밀번호를 입력해주세요!" autocomplete="off" required></input>
                            </div> -->
