                    ...
                    <fieldset>
                        ...
                        <div class="join__box">
                            ...
                            <div class="overlap">
                                ...
                                <p class="msg" id="youEmailComment"><!-- *이메일이 등록되어 있습니다. --></p>
                            </div>
                            <div class="overlap">
                                ...
                                <p class="msg" id="youNickNameComment"><!-- *닉네임이 등록되어 있습니다. --></p>
                            </div>
                            <div>
                                <label for="youName">이름</label>
                                <input type="text" id="youName" name="youName" maxlength="20" placeholder="이름을 적어주세요!" autocomplete="off" required>
                                <p class="msg" id="youNameComment"><!-- *이름은 한글로만 작성이 가능합니다. --></p>
                            </div>
                            <div>
                                <label for="youPass">비밀번호</label>
                                <input type="password" id="youPass" name="youPass" maxlength="20" placeholder="비밀번호을 적어주세요!" autocomplete="off" required>
                                <p class="msg" id="youPassComment"><!-- *비밀번호에는 특수기호와 숫자가 포함되어야 합니다. --></p>
                            </div>
                            <div>
                                <label for="youPassC">비밀번호 확인</label>
                                <input type="password" id="youPassC" name="youPassC" maxlength="20" placeholder="위의 비밀번호를 확인합니다." autocomplete="off" required>
                                <p class="msg" id="youPassCComment"><!-- *비밀번호가 일치하지 않습니다. --></p>
                            </div>
                            <div>
                                <label for="youBirth">생년월일</label>
                                <input type="text" id="youBirth" name="youBirth" maxlength="10" placeholder="YYYY-MM-DD" autocomplete="off" required>
                                <p class="msg" id="youBirthComment"><!-- *생년월일 형식이 아닙니다. --></p>
                            </div>

                            <div>
                                <label for="youPhone">휴대폰 번호</label>
                                <input type="text" id="youPhone" name="youPhone" maxlength="13" placeholder="000-0000-0000" autocomplete="off" required>
                                <p class="msg" id="youPhoneComment"><!-- *전화번호 형식이 아닙니다. --></p>
                            </div>
                        </div>
