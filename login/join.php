                    ...
                    <fieldset>
                        ...
                        <div class="join__box">
                            ...
                            <div>
                                ...
                                <input type="password" id="youPass" name="youPass" placeholder="비밀번호을 적어주세요!" autocomplete="off" required>
                            </div>
                            <div>
                                <label for="youPassC">비밀번호 확인</label>
                                <input type="password" id="youPassC" name="youPassC" placeholder="위의 비밀번호를 확인합니다." autocomplete="off" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" id="youPhone" name="youPhone" placeholder="휴대폰 번호를 적어주세요." autocomplete="off" required>
                            </div>
                        </div>
